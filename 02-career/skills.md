...
**Hinweis zur Spalte „Erfahrung“:** geschätzte Jahre **tatsächlicher praktischer Nutzung** dieser Technologie — nicht die Gesamtberufsdauer und nicht die Summe aller parallelen Tätigkeiten.
...
| Skill | Erfahrung | Kontext |
|-------|-----------|---------|
| Prometheus | 2+ Jahre | Referenzdaten (~2020), BI-Plattform (2025) |
| Grafana | 2+ Jahre | Dashboards — Referenzdaten, BI-Monitoring |
| Backup-Automatisierung | 2+ Jahre | BI-Plattform (2025), frühere projektbezogene Backups |
| Produktionssupport | 15+ Jahre | Enterprise- und Kliniksysteme im Langzeitbetrieb (2007–2022) |

## Entwicklung (selektiv)

| Skill | Erfahrung | Kontext |
|-------|-----------|---------|
| Next.js / React | 1+ Jahr | Investment-Plattform (2025) |
| Scripting (Python, Bash) | 8+ Jahre | Automatisierung und Ops-Skripte — sporadisch, projektbezogen |
| Kotlin / Spring Boot | 1+ Jahr | Microservice-Plattform — Deployment & Integration (2025) |

## Cloud & Hosting

| Anbieter | Einsatz |
|----------|---------|
| DigitalOcean | Kubernetes — KI-Lernplattform (2025) |
| Hetzner | VPS, Self-hosted Services — Freelance |
| AWS | Infrastrukturprojekte — projektbezogen |
